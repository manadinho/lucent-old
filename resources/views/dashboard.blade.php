        ...
        <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                        @forelse($projects as $project)
                            <div class="p-4 bg-white   rounded-lg shadow-2xl shadow-gray-500/20 transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    <h2 class="whitespace-nowrap overflow-hidden text-ellipsis tracking-wider text-2xl text-gray-900/90 mb-1 label">{{ $project->name }} <br><small class="text-gray-400">({{ $project->environment}})</small></h2><br>
