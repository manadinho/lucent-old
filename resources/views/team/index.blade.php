                        ...
                        @forelse($teams as $team)
                            <tr class="py-10 border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="px-4 py-4">
                                    ...
                                    <a href="" class="inline-flex float-right mr-2 items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
